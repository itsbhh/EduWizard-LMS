...
const navigate = useNavigate();
  ...
  return (
    <div className="relative bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-600 dark:from-gray-800 dark:via-gray-850 dark:to-gray-900 py-24 px-4 text-center">
